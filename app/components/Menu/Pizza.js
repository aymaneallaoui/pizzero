...
const PizzaMenu = () => {
  ...
  const renderPizzaMenu = () => {
    return pizzaMenu.map((pizza, index) => (
      <div
        className="card  bg-base-200 shadow-xl mx-4 my-4 [&::selection]:bg-neutral-focus"
        key={index}
      >
        ...
        <div className="card-body ">
          ...
          <Reveal>
            <p className="text-neutral-content [&::selection]:bg-neutral-focus">
              {pizza.description}
            </p>
          </Reveal>
          <Reveal>
            <div className="card-actions justify-end">
              {pizza.ingredients.map((ingredient, i) => (
                <div
                  className="badge badge-outline text-neutral-content [&::selection]:bg-neutral-focus"
                  key={i}
                >
                  {ingredient}
                </div>
  ...
  return (
    <div className="container mx-auto  py-6 bg-base-100">
      <h1
        className="text-3xl font-bold mt-6 mb-6 text-center text-neutral-content"
        id="Menu"
      >
        Pizza Menu
      </h1>
